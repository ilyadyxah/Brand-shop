                ...
                <form method="post" action="{{ route('shop::cart::add') }}">
                        ...
                        <details class="choose-spec-details quantity-select">
                            ...
                            <ul>
                                @for($i = 1; $i <= 5; $i++)
                                    ...
                                    @else
                                        <li>
                                            <input type="radio" name="quantity" value="{{$i}}" class="choose-spec-input"
                                                   id="quantity_{{$i}}">
                                            <label for="quantity_{{$i}}">{{$i}}</label>
                                        </li>
                                    @endif
                    ...
                    <footer class="slider-footer">
                        <div class="slider-footer-button">
                            ...
                            <input class="slider-footer-button-text" type="submit" value="Add to Cart">
                        </div>
                    </footer>
                </form>
            </section>
